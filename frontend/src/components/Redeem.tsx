...
const Redeem = ({ onRechargeCompleted }: { onRechargeCompleted?: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setRedeemCode('');
            // Call the callback when recharge is completed
            if (onRechargeCompleted) {
                onRechargeCompleted();
            }
        } catch (err) {
    ...
    return (
        <div className="space-y-6">
            <p className="text-gray-600">Inserisci il codice di riscatto per ricaricare il tuo wallet.</p>
